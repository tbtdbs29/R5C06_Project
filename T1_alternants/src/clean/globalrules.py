...
RULES_BY_CSV: RulesByCsv = {
    "answers.csv": {
        ...
        "rename_columns": {
            ...
            "🔊🎵 La qualité de l'audio est importante pour moi": "quality_relevance",
        ...
        "standardisation_rules": {
            ...
            "quality_relevance": ["trimEmoji", "trimSpaces", "convertToQuantitative", "toLowerCase"],
        ...
        "validation_rules": {
            ...
            "quality_relevance": ["notNull", "float", "positiveNumber"],
